...
def load_api_data(date_str):
    ...
    # --- ГИФКА ЗАГРУЗКИ (НАЧАЛО) ---
    loading_placeholder = st.empty()
    loading_placeholder.markdown(
        """
        <div style="display: flex; justify-content: center;">
            <img src="https://i.gifer.com/ZZ5H.gif" width="300" />
        </div>
        <p style="text-align: center;">Робот собирает данные из Chat2Desk... Подождите...</p>
        """, 
        unsafe_allow_html=True
    )
    # -------------------------------
    ...
    loading_placeholder.empty() # Убираем гифку
...
with tabs[2]:
    ...
    if not df_api.empty:
        ...
        if selected_dept:
            ...
            # Используем безопасное преобразование в числа (errors='coerce')
            # 1. Рейтинг отдела
